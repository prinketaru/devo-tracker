      ...
      <main className="flex-1 max-w-3xl mx-auto px-6 py-12 w-full">
        ...
        <article className="prose dark:prose-invert max-w-none">
          <div className="mb-6">
            ...
            <div className="flex flex-wrap items-center gap-3 text-stone-600 dark:text-[#7e7b72]">
              <time>
          ...
          <div className="my-8 border-t border-stone-200 dark:border-[#2a2720]"></div>

          <Markdown>{announcement.content}</Markdown>
        </article>

        <div className="mt-12 border-t border-stone-200 dark:border-[#2a2720] pt-8">
          <Link
            href="/announcements"
