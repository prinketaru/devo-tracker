    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-12 w-full">
        <div className="mb-12">
          ...
          <p className="text-lg text-stone-600 dark:text-[#b8b5ac]">
        ...
        {announcements.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-stone-600 dark:text-[#7e7b72]">
          ...
          <div className="space-y-8">
            {announcements.map((announcement) => (
              <article
                ...
                className="border border-stone-200 dark:border-[#2a2720] rounded-lg p-6 hover:shadow-md dark:hover:shadow-lg transition-shadow"
              >
                <div className="flex items-start justify-between gap-4 mb-3">
                  <div>
                    <Link
                      href={`/announcements/${announcement.slug}`}
                      className="text-2xl font-bold text-stone-900 dark:text-[#d6d3c8] hover:text-amber-600 dark:hover:text-amber-400 transition-colors"
                    >
                      {announcement.title}
                    </Link>
                  </div>
                ...
                <div className="flex items-center gap-3 text-sm text-stone-500 dark:text-[#7e7b72]">
                  <time>
